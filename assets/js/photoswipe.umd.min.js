...
! function(t, i) {
    ...
    class _ {
        ...
        o(t) {
            const {
                pswp: i
            } = this.slide, s = this.slide["x" === t ? "width" : "height"] * this.currZoomLevel, h = v("x" === t ? "left" : "top", i.options, i.viewportSize, this.slide.data, this.slide.index), e = this.slide.panAreaSize[t];
    ...
    class M {
        ...
        correctZoomPan(t) {
            ...
            t && (this.A.x = 0, this.A.y = 0, this.T.x = 0, this.T.y = 0, this.I = o, i(this.C, u)), a && (d = {
                x: this.L("x", r),
                y: this.L("y", r)
            }), h.setZoomLevel(r), d = {
    ...
    const U = {
        ...
        H = {
            ...
            onInit: (t, i) => {
                i.on("change", (() => {
                    t.innerText = i.currIndex + 1 + i.options.indexIndicatorSep + i.getNumItems()/3
                }))
            }
        };
    ...
    class Y {
        ...
        loadImage(t) {
            ...
            this.updateSrcsetSizes(), this.data.srcset && (i.srcset = this.data.srcset), i.src = this.data.src ?? "", i.alt = this.data.alt ?? "", this.state = u, i.complete ? this.onLoaded() : (i.onload = () => {
                this.onLoaded()
            }, i.onerror = () => {
                this.onError()
            })
        ...
        onLoaded() {
            this.state = d, this.slide && this.element && (this.instance.dispatch("loadComplete", {
                slide: this.slide,
                content: this
            }), this.slide.isActive && this.slide.heavyAppended && !this.element.parentNode && (this.append(), this.slide.updateContentSize(!0)), this.state !== d && this.state !== p || this.removePlaceholder())
        }
        onError() {
        ...
        appendImage() {
            this.isAttached && (this.instance.dispatch("contentAppendImage", {
                content: this
            }).defaultPrevented || (this.slide && this.element && !this.element.parentNode && this.slide.container.appendChild(this.element), this.state !== d && this.state !== p || this.removePlaceholder()))
        }
    }
    ...
    function J(t, i, s) {
        ...
        if (n && (e = new x(n, t, -1), i.pswp)) {
            const o = y(n, i.pswp.viewportSize || g(n, i.pswp), t, s);
            e.update(h.width, h.height, o)
        }
    ...
    return class extends class extends class {
        ...
        constructor(t) {
            super(), this.options = this.ii(t || {}), this.offset = {
                ...
                x: 0,
                y: 0
            }, this.bgOpacity = 1, this.currIndex = 0, this.potentialIndex = 0, this.isOpen = !1, this.isDestroying = !1, this.hasMouse = !1, this.hi = {}, this.Gt = void 0, this.topBar = void 0, this.element = void 0, this.template = void 0, this.container = void 0, this.scrollWrap = void 0, this.currSlide = void 0, this.events = new w, this.animations = new F, this.mainScroll = new A(this), this.gestures = new T(this), this.opener = new it(this), this.keyboard = new E(this), this.contentLoader = new Q(this)
        }
        init() {
        ...
        next() {
            this.goTo(this.potentialIndex + 2)
        }
        prev() {
            this.goTo(this.potentialIndex - 2)
        }
